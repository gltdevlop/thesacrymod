 ...
 *
 */
package fr.gltdevlop.thesacrymod;
...
import fr.gltdevlop.thesacrymod.init.ThesacrymodModBlocks;
import fr.gltdevlop.thesacrymod.init.ThesacrymodModBiomes;

@Mod("thesacrymod")
public class ThesacrymodMod {
	public static final Logger LOGGER = LogManager.getLogger(ThesacrymodMod.class);
	public static final String MODID = "thesacrymod";

	public ThesacrymodMod() {
		...
		ThesacrymodModMenus.REGISTRY.register(bus);
		ThesacrymodModBiomes.REGISTRY.register(bus);
